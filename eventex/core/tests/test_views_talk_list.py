...
class TalkListTest(TestCase):
	def setUp(self):
		s = Speaker.objects.create(name='Henrique Bastos', slug='henrique-bastos', url='http://henriquebastos.net', description='Passionate software developer!')
	...
	def test_html(self):
		...
		self.assertContains(self.resp, u'/palestrante/henrique-bastos/', 2)
