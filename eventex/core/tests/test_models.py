...
class ContactModelTest(TestCase):
	...
	def test_phone(self):
		contact = Contact.objects.create(speaker=self.speaker, kind='P', value='21-999999999')
		self.assertEqual(1, contact.pk)

	def test_fax(self):
		contact = Contact.objects.create(speaker=self.speaker, kind='F', value='21-999999999')
		self.assertEqual(1, contact.pk)

	def test_kind(self):
		'Contact kind shold be limited to E, P ou F'
